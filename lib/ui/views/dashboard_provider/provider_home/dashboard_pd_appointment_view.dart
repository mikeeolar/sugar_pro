...
class DashboardPdAppointmentDetailView extends StackedView<PdAppointmentDetailViewModel> {
  const DashboardPdAppointmentDetailView({super.key, required this.app});

  final Appointments app;
