...
class StorageService with ListenableServiceMixin {
  ...
  bool get _isDoubleBoxOpen => _hiveService.isBoxOpen(HiveBox.doubles);
  Box<double> get _doubleBox => _hiveService.box<double>(HiveBox.doubles);
  ...
  Future<void> init() async {
    ...
    if (!_isDoubleBoxOpen) {
      await _hiveService.openBox<double>(HiveBox.doubles);
    }
    if (!_isIntBoxOpen) {
